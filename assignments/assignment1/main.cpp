...
int main() {
	...
	// THIS SECTION OF CODE WAS GENERATED BY OPENAI'S CHATGPT 3.5 USING THE PROMPT "can you give me code that creates a single quad vertex array object for OpenGL 4.5 in C++"
	...
	// END OF CODE WRITTEN BY CHATGPT 3.5
